...
Here! [http://web.ctflearn.com/web7/](http://web.ctflearn.com/web7/) I forget how we were doing those calculations, but something tells me it was pretty insecure.
...
[http://web.ctflearn.com/web8/](http://web.ctflearn.com/web8/)
and I think they have the flag in their somewhere. UNION might be a helpful command
...
Then I checked the available columns by querying:
...
As we now have the column and table names, our final query should be:
